...
class SPeoplePlugin(CMSPluginBase):

    TEMPLATE_NAME = 'ssrd_people/plugins/%s/people_list.html'
    module = 'People'
    render_template = TEMPLATE_NAME % models.SPeoplePlugin.STYLE_CHOICES[0][0]
    name = _('People list')
    model = models.SPeoplePlugin
...
plugin_pool.register_plugin(SPeoplePlugin)
