    ...
    def populate(self):
        ...
        if user and view_name:
            ...
            if change_group_perm:
                url = admin_reverse('ssrd_people_group_changelist')
            ...
            if add_group_perm:
                ...
                url = get_admin_url('ssrd_people_group_add', **url_args)
                menu.add_modal_item(_('Add new group'), url=url)

            if change_group_perm and group:
                url = get_admin_url('ssrd_people_group_change', [group.pk, ])
            ...
            if change_person_perm:
                url = admin_reverse('ssrd_people_person_changelist')
            ...
            if add_person_perm:
                ...
                url = get_admin_url('ssrd_people_person_add', **url_args)
                menu.add_modal_item(_('Add new person'), url=url)

            if change_person_perm and person:
                url = admin_reverse(
                    'ssrd_people_person_change', args=(person.pk, ))
