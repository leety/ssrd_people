...
from ..cms_plugins import SPeoplePlugin
...
class TestPersonPlugins(DefaultApphookMixin, BasePeopleTest):
    ...
    def test_add_people_list_plugin_api(self):
        ...
        plugin = api.add_plugin(self.placeholder, SPeoplePlugin, self.language)
    ...
    #     """
    #     We log into the SPeoplePlugin
    #     """
    #     self.client.login(
    #         username=self.su_username, password=self.su_password)
    #
    #     plugin_data = {
    #         'plugin_type': 'SPeoplePlugin',
    ...
    def create_plugin(self, plugin_params=None):
        ...
        with force_language('en'):
            plugin = api.add_plugin(
                self.placeholder, SPeoplePlugin, 'en', **plugin_params)
