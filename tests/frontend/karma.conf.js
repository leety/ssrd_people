...
module.exports = function (config) {
    ...
    var settings = {
        ...
        files: [
            ...
            '../../ssrd_people/boilerplates/bootstrap3/static/js/libs/*.js',
            '../../ssrd_people/boilerplates/bootstrap3/static/js/addons/*.js',
        ...
        preprocessors: {
            '../../ssrd_people/boilerplates/bootstrap3/static/js/addons/*.js': ['coverage'],
            // for fixtures
            '**/*.html': ['html2js'],
            '**/*.json': ['json_fixtures']
        },
