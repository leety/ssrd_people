...
class Group(TranslationHelperMixin, TranslatedAutoSlugifyMixin,
            TranslatableModel):
    slug_source_field_name = 'affiliation name'
    translations = TranslatedFields(
        name=models.CharField(_('name'), max_length=255,
                              help_text=_("Provide this affiliation's name.")),
    ...
    class Meta:
        verbose_name = _('Affiliation') #University name here!
...
class Person(TranslationHelperMixin, TranslatedAutoSlugifyMixin,
    ...
    translations = TranslatedFields(
        ...
        slug=models.SlugField(_('unique slug'), max_length=255, blank=True,
            default='',
            help_text=_("Leave blank to auto-generate a unique slug.")),
        function=models.CharField(_('title'),
            max_length=255, blank=True, default=''),
        description=HTMLField(_('Bio'),
            blank=True, default='')
    )
    phone = models.CharField(
        verbose_name=_('phone'), null=True, blank=True, max_length=100)
    ...
    groups = SortedM2MModelField(
        ...
        help_text=_('Choose and order the affiliation for this person, the first '
                    'will be the "primary affiliation".'))
...
class SPeoplePlugin(BasePeoplePlugin):
